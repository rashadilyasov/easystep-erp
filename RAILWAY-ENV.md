...
1. **Admin panel:** Şirkətlər → **Kontent** səhifəsi → «Son əlaqə mesajları» bölməsi
2. **E-poçt:** Hər yeni mesaj `App__AdminEmail` (və ya default `info@easysteperp.com`) ünvanına göndərilir
3. **Railway Variables:** `App__AdminEmail=info@easysteperp.com` (və ya istədiyiniz e-poçt)
...
| `App__BaseUrl` | `https://www.easysteperp.com` |
| `App__ApiBaseUrl` | `https://api.easysteperp.com` |
| `App__AdminEmail` | Əlaqə formu bildirişləri (məs: `info@easysteperp.com`). Təyin edilməzsə default `info@easysteperp.com` istifadə olunur |
