...
export const metadata = {
  title: "Satış partnyoru qeydiyyatı | Easy Step ERP",
  description: "Easy Step ERP satış partnyoru proqramına qoşulun.",
};
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8">
            <h1 className="text-2xl font-bold text-slate-900 mb-2">Satış partnyoru qeydiyyatı</h1>
